...
MM.widgets = {
    ...
    renderIframeModule: function(title, path) {
        ...
        var content = '<div style="background-color:#154284;border:0;border-radius:0;display: table; width: 100%;height: 40px;"><div id="dialog-close" style="display: table-cell; text-align: right;padding-right:10px;color:white;padding-top:10px;">X</div></div><div style="' + divstyle + '">' + iframe + '</div>';
        ...
        $("#dialog-close").on(MM.clickType, function(e){
            ...
            $('#app-dialog').html('<div><div class="modalHeader">
                </div>
