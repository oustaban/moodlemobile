...
MM.widgets = {
	...
	onloadScript+= 'if (iframe.contentDocument.body.offsetHeight!=0) {';
	onloadScript+= 'iframe.style.height = (iframe.contentDocument.body.offsetHeight - 0) + "px";';
	onloadScript+= '} else {';
	onloadScript+= 'iframe.style.height = (iframe.parentNode.offsetHeight - 40) + "px";';
	onloadScript+= '}';
	onloadScript+= 'if (iframe.contentDocument.body.offsetWidth!=0) {';
	onloadScript+= 'iframe.style.width = iframe.contentDocument.body.offsetWidth + "px";';
	onloadScript+= '} else {';
	onloadScript+= 'iframe.style.width = iframe.parentNode.offsetWidth + "px";';
	onloadScript+= '}';
        onloadScript+= '}}</script>';
