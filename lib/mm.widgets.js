...
MM.widgets = {
    ...
    renderIframeModule: function(title, path) {
        var height = $(window).height() - 200;
	var percentHeight = parseInt(((iframe.contentDocument.body.offsetHeight - 40) / iframe.contentDocument.body.offsetHeight)*100);
        ...
        onloadScript+= 'iframe.style.height = (iframe.contentDocument.body.offsetHeight - 140) + "px";';
