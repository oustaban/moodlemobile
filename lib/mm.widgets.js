...
MM.widgets = {
    ...
    renderIframeModule: function(title, path) {
        ...
        var content = '<div style=" display: table; width: 100%;height: 40px;"><div id="dialog-close" style="display: table-cell; text-align: right;">X</div></div><div style="' + divstyle + '">' + iframe + '</div>';
