...
MM.widgets = {
    ...
    renderIframeModal: function(title, path) {
        ...
        MM.handleExternalLinks('.modalHeader a[target="_self"]');
        ...
        setTimeout(function() {
            $('#page-view-iframe').contents().find('a').click(function(e) {
                ...
                if (href.indexOf("http") > -1) {
                    e.preventDefault();
                    window.open(href, '_self','location=no','toolbar=yes','closebuttoncaption=Return');
                }
            });
        }, 1000);
    ...
    renderIframeModalContents: function(title, html) {
        ...
        setTimeout(function() {
            iframe.contents().find('a').click(function(e) {
                ...
                if (href.indexOf("http") > -1) {
                    e.preventDefault();
                    window.open(href, '_blank','location=no','toolbar=yes','closebuttoncaption=Return');
                }
            });
        }, 1000);
