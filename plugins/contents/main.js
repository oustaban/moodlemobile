...
define(templates,function (sectionsTpl, contentsTpl, folderTpl, mimeTypes) {
    var plugin = {
	    ...
	    // Adding loading icon.
            ...
            MM.moodleWSCall('local_mobile_get_course_contents_and_pif', data, function(contents) {
        ...
        viewCourseContentsSection: function(courseId, sectionId) {
            ...
            MM.moodleWSCall(
                'local_mobile_get_course_contents_and_pif',
                data,
                function(contents) {
                    var course = MM.db.get("courses", MM.config.current_site.id + "-" + courseId);
                    ...
                    MM.log('DEBUG:'+sectionId+'/'+sectionName+'/'+courseId+'/'+course+'/'+sections.modules.length);
